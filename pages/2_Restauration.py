...
.dept-header { background:linear-gradient(135deg,#7b2d00 0%,#c0392b 100%); padding:1.2rem 2rem; border-radius:12px; margin-bottom:1.5rem; margin-top:1.2rem; }
.dept-header h2 { color:white !important; margin:0; font-size:1.5rem; }
.dept-header p  { color:#f5b7b1; margin:0.3rem 0 0; font-size:0.88rem; }
</style>
"""
...
<div class="dk-navbar">
    ...
    <nav class="dk-nav">
        ...
        <a href="/2_Restauration" class="nav-item active" target="_self">🍽️ Restauration</a>
